  <header class="main-header">
    ...
    <a href="{{route('home')}}" class="logo">
      ...
      <span class="logo-mini"><b>B</b>PHN MIS</span>
      <img src="{{url('/')}}/public/images/logo2.png">
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BPHN MIS</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{Auth::user()->img_url}}" class="user-image" alt="User Image" id="top-dp">
              <span class="hidden-xs">{{Auth::user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{Auth::user()->img_url}}" class="img-circle" alt="{{Auth::user()->name}}" id="nav-dp">
