  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Deficiency Categories</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="box box-default">
          <div class="box-body">
            @ability('Admin','Create-Deficiency-Category')
                ...
                @foreach($categories as $key => $cat)
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-xs btn-info btn-flat" data-toggle="modal" id="showPreview" onclick="show({{$cat->id}})">
                        <span class="fa fa-eye"></span>
                      </button>

                      <button class="btn btn-xs btn-danger btn-flat" data-toggle="modal" id="showPreview" onclick="activationAction({{$cat->id}})">
                      <span class="fa fa-power-off"></span>
                      </button>

                      <button class="btn btn-xs btn-danger btn-flat" data-toggle="modal" id="showPreview" onclick="deletionAction({{$cat->id}})">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center">NEW DEFICIENCY CATEGORY</h4>
        </div>
        <div class="modal-body">
          ...
          <form id="deficiencycategories" action="{{route('deficiencycategories.store')}}" method="POST">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $("#submit").click(function(e){
        ...
        var _url = $("#deficiencycategories").attr("action");
        ...
        var _data = $("#deficiencycategories").serialize();
          ...
          $.ajax({
              ...
              success: function(data) {
                  ...
                  if($.isEmptyObject(data.error)){
                    swal({
                      title: "Created!",
                      text: "Deficiency Category Added",
                      icon: "success",
                      button: false,
                      timer: 2000,
  ...
  function deletionAction(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencycategories/"+id+"/deletion";
  ...
  function show(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencycategories/"+id;
  ...
  function getEditForm(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencycategories/"+id+"/edit";
  ...
  $("#showcontent").on('click', '#submitEdit',function(e){
    ...
    var _url = $("#editDefcat").attr("action");
    ...
    var _data = $("#editDefcat").serialize();
  ...
  function activationAction(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencycategories/"+id+"/activation";
