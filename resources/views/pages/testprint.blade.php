    ...
    <div class="wrapper">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            <table class="table">
              <tbody>
                <tr>
                  <td>Inspection Code: &nbsp; <b>{{$inspection->code}}</b></td>
                  <td style="text-align: center;">Inspection Date: &nbsp; <b>{{$inspection->date}}</b></td>
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            ...
            @php
              $avgScore = (($totalScore/$inspection->total_inspected_area) + ($totalScore/$total_deficiency_count))/2;
            @endphp
        ...
        <div class="col-md-12 col-xs-12 col-sm-12" style="padding-top: 330px">
            <div class="col-md-4 col-sm-4 col-xs-4 text-center">
                <b></b>
                <h5 style="text-decoration: overline;">Program Conducted By</h5>
            </div>
