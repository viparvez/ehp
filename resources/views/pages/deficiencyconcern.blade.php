  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Deficiency Concerns</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="box box-default">
          <div class="box-body">
            @ability('Admin','Create-Deficiency-Concern')
                ...
                @foreach($concerns as $key => $con)
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-xs btn-info btn-flat" data-toggle="modal" id="showPreview" onclick="show({{$con->id}})">
                        <span class="fa fa-eye"></span>
                      </button>

                      <button class="btn btn-xs btn-danger btn-flat" data-toggle="modal" id="showPreview" onclick="activationAction({{$con->id}})">
                      <span class="fa fa-power-off"></span>
                      </button>

                      <button class="btn btn-xs btn-danger btn-flat" data-toggle="modal" id="showPreview" onclick="deletionAction({{$con->id}})">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center">NEW DEFICIENCY CONCERN</h4>
        </div>
        <div class="modal-body">
          ...
          <form id="deficiencyconcenrs" action="{{route('deficiencyconcerns.store')}}" method="POST">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $("#submit").click(function(e){
        ...
        var _url = $("#deficiencyconcenrs").attr("action");
        ...
        var _data = $("#deficiencyconcenrs").serialize();
  ...
  function show(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencyconcerns/"+id;
  ...
  function getEditForm(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencyconcerns/"+id+"/edit";
  ...
  $("#showcontent").on('click', '#submitEdit',function(e){
    ...
    var _url = $("#editDefcon").attr("action");
    ...
    var _data = $("#editDefcon").serialize();
  ...
  function deletionAction(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencyconcerns/"+id+"/deletion";
  ...
  function activationAction(id) {
    ...
    var showUrl = "{{url('/')}}/deficiencyconcerns/"+id+"/activation";
