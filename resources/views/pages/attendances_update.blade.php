        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            @if(\Request::route()->getName() == 'attendances.showForm')
              @if(!empty($apartments))
              <form method="POST" id="attendance" action="{{route('attendances.update',$apartments[0]['facility_id'])}}">
                ...
                <div class="col-md-8 col-md-offset-2 col-xs-12" style="min-height: 300px">
                  ...
                  @if(!empty($fileHas))
                    <div class="col-md-6 col-xs-12 col-md-offset-4">
                      <h3><a href="{{url('/')}}{{$fileHas[0]->file}}" download>DOWNLOAD DOCUMENT</a></h3><br>
                    </div>
                  @else
                  ...
                  @endif
                    ...
                    @foreach($apartments as $k => $ap)
                      @if(in_array($ap['id'],$occupied))
                        <div class="col-md-4 col-xs-12" style="padding-bottom: 20px">
                          <label class="container">{{$ap['name']}}
                            <input type="checkbox" name="foo" id="{{$ap['id']}}" id="checkbox" onclick="attendance('{{$ap['id']}}')" checked="">
                            <input type="hidden" name="attendance[{{$ap['id']}}]" value="1" id="attendance{{$ap['id']}}">
                            <span class="checkmark"></span>
                          </label>
                        </div>
                      @else
                        <div class="col-md-4 col-xs-12" style="padding-bottom: 20px">
                          <label class="container">{{$ap['name']}}
                            <input type="checkbox" name="foo" id="{{$ap['id']}}" id="checkbox" onclick="attendance('{{$ap['id']}}')">
                ...
                <div class="col-md-4 col-xs-12 col-md-offset-4">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="comment">{{$commentHas[0]->comment}}</textarea>
                  </div>
                </div>
                @else
